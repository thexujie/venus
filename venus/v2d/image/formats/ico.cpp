...
img_ix ico_create(img_u8 * buffer, img_ix length, image_data_t * img, img_ix index)
{
	...
	else
	{
		...
		img_ix width = (img_ix)plane->width;
		img_ix height = (img_ix)plane->height;
