...
inline xmf xm_vec_set(float_32 x, float_32 y, float_32 z, float_32 w)
{
#ifdef VXM_SSE
...
// 复制
inline xmf xm_vec_replicate(float_32 value)
{
#ifdef VXM_SSE
...
inline xmf xm_vec_permute(xmf v1, xmf v2, uint_32 pmx, uint_32 pmy, uint_32 pmz, uint_32 pmw)
{
	const uint_32 * aPtr[2];
	aPtr[0] = (const uint_32 *)(&v1);
	aPtr[1] = (const uint_32 *)(&v2);

	xmf Result;
	uint_32 *pWork = (uint_32 *)(&Result);

	const uint_32 i0 = pmx & 3;
	const uint_32 vi0 = pmx >> 2;
	pWork[0] = aPtr[vi0][i0];

	const uint_32 i1 = pmy & 3;
	const uint_32 vi1 = pmy >> 2;
	pWork[1] = aPtr[vi1][i1];

	const uint_32 i2 = pmz & 3;
	const uint_32 vi2 = pmz >> 2;
	pWork[2] = aPtr[vi2][i2];

	const uint_32 i3 = pmw & 3;
	const uint_32 vi3 = pmw >> 2;
	pWork[3] = aPtr[vi3][i3];
	return Result;
}

// General permute template
template<uint_32 PermuteX, uint_32 PermuteY, uint_32 PermuteZ, uint_32 PermuteW>
inline xmf xm_vec_permute(xmf v1, xmf v2)
{
#ifdef VXM_SSE
	const uint_32 Shuffle = _MM_SHUFFLE(PermuteW & 3, PermuteZ & 3, PermuteY & 3, PermuteX & 3);
...
inline xmf xm_vec_swizzle(xmf v, uint_32 E0, uint_32 E1, uint_32 E2, uint_32 E3)
{
	const uint_32 * aPtr = (const uint_32 *)(&v);
...
template<uint_32 SwizzleX, uint_32 SwizzleY, uint_32 SwizzleZ, uint_32 SwizzleW>
...
inline xmf xm_vec_shift_left(xmf v1, xmf v2, uint_32 elements)
{
...
inline xmf xm_vec_lerp(xmf min, xmf max, float_32 lerp)
{
#ifdef VXM_SSE
...
#else
	float_32 val  = v1.af[0] * v2.af[0] + v1.af[1] * v2.af[1] + v1.af[2] * v2.af[2] + v1.af[3] * v2.af[3];
...
#else
	float_32 fValue = v1.af[0] * v2.af[0] + v1.af[1] * v2.af[1] + v1.af[2] * v2.af[2];
