...
float4x4 & float4x4::rotate_axis(const float4 & axis, float_32 angle)
{
...
float4x4 & float4x4::perspective_lh(float_32 fovy, float_32 aspect, float_32 z_near, float_32 z_far)
{
	*this = xmm_matr_perspective_lh(fovy, aspect, z_near, z_far);
	return *this;
}

float4x4 & float4x4::perspective_rh(float_32 fovy, float_32 aspect, float_32 z_near, float_32 z_far)
{
