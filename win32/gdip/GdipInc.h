...
// gdiplus.dll can NOT load dynamic, we can NOT GetProcAddress of GdiplusStartup
// if we dynamic load gdiplus.dll.
// but we can load it delay by '/DELAYLOAD:gdiplus.dll' as the same.
#include <GdiPlus.h>
